...
import models.daos.OAuth2InfoDAO.data
 ...
 */
class OAuth2InfoDAO @Inject() (implicit val ec: ExecutionContext, implicit val classTag: ClassTag[OAuth2Info]) extends DelegableAuthInfoDAO[OAuth2Info] {
